...
export const Results = (
    {score,questionsFiltered,onReset}
) =>{
    return(
        <div className="flex flex-col justify-center items-center shadow-xl rounded-lg w-[600px] h-[600px]">
        ...
        <button onClick={onReset} className="border px-5 py-2 rounded-lg transition-all font bold hover:bh-yellow-500 hover:text-gray-900">
            vamos de nuevo
        </button>
